...
function useAuthData({
  ...
  const [isPending, setIsPending] = _react.useState.call(void 0, true);
...
var AuthUIProvider = ({
  ...
  const viewPaths = _react.useMemo.call(void 0, () => {
    return { ..._chunkYXXX6ULKcjs.authViewPaths, ...viewPathsProp };
  }, [viewPathsProp]);
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    AuthUIContext.Provider,
    {
      ...
      children: (captcha == null ? void 0 : captcha.provider) === "google-recaptcha-v3" ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, RecaptchaV3, { children }) : children
    }
  );
};
...
exports.useIsHydrated = useIsHydrated; exports.useLang = useLang; exports.useTheme = useTheme; exports.authLocalization = authLocalization; exports.AuthUIContext = AuthUIContext; exports.AuthUIProvider = AuthUIProvider;
