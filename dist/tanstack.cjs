...
function useTanstackOptions({ authClient }) {
  const {
    useUnlinkAccount,
    useUpdateUser,
    useDeletePasskey,
...
function AuthUIProviderTanstack({
  ...
  const hooks = _react.useMemo.call(void 0, () => ({ ...contextHooks, ...hooksProp }), [contextHooks, hooksProp]);
  const mutators = _react.useMemo.call(void 0, 
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    _chunkQ2MIXEU6cjs.AuthUIProvider,
    {
      authClient,
      hooks,
      mutators,
